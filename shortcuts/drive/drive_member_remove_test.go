...
func TestDriveMemberRemoveSpecRequestShape(t *testing.T) {
	...
	if got := driveMemberRemovePath(driveMemberRemoveSpec{Token: "token/with/slash", MemberID: "member/with/slash"}); got != "/open-apis/drive/v1/permissions/token%2Fwith%2Fslash/members/member%2Fwith%2Fslash" {
